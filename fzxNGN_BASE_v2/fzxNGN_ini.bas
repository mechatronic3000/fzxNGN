...
$IF FZXINIINCLUDE = UNDEFINED THEN
  ...
  CONST cMAXNUMBEROFOBJECTS = 100 ' Max number of objects at one time
  CONST cMAXNUMBEROFPOLYGONS = 1000 ' Max number of total vertices included in all objects
  CONST cMAXNUMBEROFHITS = 1000
  CONST cMAXVERTSPERBODY = 64


  DIM SHARED AS tFZX_BODY __fzxBody(200)
  DIM SHARED AS tFZX_JOINT __fzxJoints(100)
  DIM SHARED AS tFZX_HIT __fzxHits(cMAXNUMBEROFHITS)
