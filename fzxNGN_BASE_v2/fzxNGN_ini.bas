...
$IF FZXINIINCLUDE = UNDEFINED THEN
  ...
  CONST CFZX_PARAMETER_POLYCOUNT = 29 ' readonly

  CONST cFZX_NET_NONE = 0
  CONST cFZX_NET_SERVER = 1
  CONST cFZX_NET_CLIENT = 2

  CONST cFZX_MOUSE_NONE = 0
  CONST cFZX_MOUSE_HOVER = 1
  CONST cFZX_MOUSE_CLICK = 2
  CONST cFZX_MOUSE_DOUBLECLICK = 3



  CONST cSTARTINGNUMBEROFOBJECTS = 10 ' starting number of objects
  CONST cSTARTINGNUMBEROFJOINTS = 10
  CONST cSTARTINGNUMBEROFHITS = 200
